...
@Documented
@Repeatable(CsvLengthMin.List.class)
@CsvConstraint(value={})
public @interface CsvLengthMin {
     ...
     *   <li>min : アノテーションの属性{@link #value()}の値です。</li>
     * </ul>
     * 
     * @return 省略した場合は、適用された{@link CellProcessor}に基づいたメッセージが出力されます。
     */
    String message() default "{com.github.mygreen.supercsv.annotation.constraint.CsvLengthMin.message}";
