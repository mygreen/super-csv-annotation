 ...
 * 
 * <ul>
 *   <li>属性{@link #value()}で、下限値としての日時を指定します。
 ...
 *     {@literal @CsvDateTimeMin("2050/12/31")}
 *     private LocalDate birthday;
 *     
 *     // 比較する際には指定した値より後かどうかで判定します。
 *     {@literal @CsvColumn(number=2)}
 *     {@literal @CsvDateTimeMin(value="9999-12-31 23:59:59.999", inclusive=false)}
