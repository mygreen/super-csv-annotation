...
@Documented
@Repeatable(CsvUniqueHashCode.List.class)
@CsvConstraint(value={})
public @interface CsvUniqueHashCode {
     ...
     *   <li>hashCode : valueに対するハッシュ値です。</li>
     ...
     */
    String message() default "{com.github.mygreen.supercsv.annotation.constraint.CsvUniqueHashCode.message}";
