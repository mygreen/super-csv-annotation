...
@Documented
@Repeatable(CsvDateTimeRange.List.class)
@CsvConstraint(value={})
public @interface CsvDateTimeRange {
     ...
     * @return {@code true}の場合、日時以降か、以前かどうかとして比較します。
     *         {@code false}の場合、値より後か、前かどうかとして比較します。
     */
     ...
     */
    String message() default "{com.github.mygreen.supercsv.annotation.constraint.CsvDateTimeRange.message}";
