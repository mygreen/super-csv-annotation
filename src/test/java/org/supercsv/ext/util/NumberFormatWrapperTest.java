...
public class NumberFormatWrapperTest {
    ...
    private NumberFormatWrapper formatter;
    private NumberFormatWrapper lenientFormatter;
    private NumberFormatWrapper parseBigDecimalFormatter;
    private NumberFormatWrapper lenientParseBigDecimalFormatter;
    ...
    public void setUp() {
        ...
        this.formatter = new NumberFormatWrapper(df1);
        this.lenientFormatter = new NumberFormatWrapper(df1, true);
        
        DecimalFormat df2 = new DecimalFormat("#,##0.0##");
        df2.setParseBigDecimal(true);
        this.parseBigDecimalFormatter = new NumberFormatWrapper(df2);
        this.lenientParseBigDecimalFormatter = new NumberFormatWrapper(df2, true);
    }
    
    @Test(expected=NullPointerException.class)
    public void testConstructorAtFormatterNull() {
        new NumberFormatWrapper((NumberFormat) null);
        fail();
    }
    
    @Test
    public void testGetPattern() {
        assertThat(formatter.getPattern(), is("#,##0.0##"));
        assertThat(lenientFormatter.getPattern(), is("#,##0.0##"));
    ...
    public void testFormatWithValid() {
        ...
        assertThat(formatter.format(123456), is("123,456.0"));
        assertThat(formatter.format(-2.4567), is("-2.457"));
        
        assertThat(lenientFormatter.format(123456), is("123,456.0"));
        assertThat(lenientFormatter.format(-2.4567), is("-2.457"));
    }
    
    @Test(expected=IllegalArgumentException.class)
    public void testFormatWithInvalidAtNull() {
        formatter.format((Integer)null);
        fail();
    }
