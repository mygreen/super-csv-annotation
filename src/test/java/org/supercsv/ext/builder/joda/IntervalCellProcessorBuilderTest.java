...
/**
 * Test the {@link IntervalCellProcessorBuilder} CellProcessor.
 *
 * @since 1.2
 * @author T.TSUCHIE
 *
 */
public class IntervalCellProcessorBuilderTest {
    
    @Rule
    public TestName name = new TestName();
    
    private IntervalCellProcessorBuilder builder;
    ...
    @Before
    public void setUp() {
        builder = new IntervalCellProcessorBuilder();
    }
    
    private static final Interval TEST_VALUE_1_OBJ = Interval.parse("2016-02-29T07:12:01.000+09:00/2050-12-31T23:59:59.999+09:00");
    private static final String TEST_VALUE_1_STR_NORMAL = "2016-02-29T07:12:01.000+09:00/2050-12-31T23:59:59.999+09:00";
    
    private static final Interval TEST_VALUE_2_OBJ = Interval.parse("2020-01-31T10:08:35.000+09:00/2050-12-31T23:59:59.999+09:00");
    private static final String TEST_VALUE_2_STR_NORMAL = "2020-01-31T10:08:35.000+09:00/2050-12-31T23:59:59.999+09:00";
    
    private static final Interval TEST_VALUE_INPUT_DEFAULT_OBJ = Interval.parse("2000-01-01T08:02:03.000+09:00/2050-12-31T23:59:59.999+09:00");
    private static final String TEST_VALUE_INPUT_DEFAULT_STR_NORMAL = "2000-01-01T08:02:03.000+09:00/2050-12-31T23:59:59.999+09:00";
    
    private static final Interval TEST_VALUE_OUTPUT_DEFAULT_OBJ = Interval.parse("2015-12-31T12:31:01.000+09:00/2050-12-31T23:59:59.999+09:00");
    private static final String TEST_VALUE_OUTPUT_DEFAULT_STR_NORMAL = "2015-12-31T12:31:01.000+09:00/2050-12-31T23:59:59.999+09:00";
    
    @CsvBean
    private static class TestCsv {
        
        @CsvColumn(position=0)
        Interval duration_default;
        
        @CsvColumn(position=1, optional=true)
        Interval duration_optional;
        
        @CsvColumn(position=2, trim=true)
        Interval duration_trim;
    ...
    public void testBuildInput_default() {
        ...
        CellProcessor cellProcessor = builder.buildInputCellProcessor(Interval.class, annos);
        printCellProcessorChain(cellProcessor, name.getMethodName());
        
        assertThat(cellProcessor, hasCellProcessor(NotNull.class));
        assertThat(cellProcessor, hasCellProcessor(ParseInterval.class));
        ...
        try {
            ...
            CellProcessor errorProcessor = e.getProcessor();
            assertThat(errorProcessor, is(instanceOf(ParseInterval.class)));
        }
    ...
    public void testBuildOutput_default() {
        ...
        Annotation[] annos = getAnnotations(TestCsv.class, "duration_default");
        CellProcessor cellProcessor = builder.buildOutputCellProcessor(Interval.class, annos, false);
        printCellProcessorChain(cellProcessor, name.getMethodName());
    ...
    public void testBuildOutput_default_ignoreValidation() {
        ...
        Annotation[] annos = getAnnotations(TestCsv.class, "duration_default");
        CellProcessor cellProcessor = builder.buildOutputCellProcessor(Interval.class, annos, true);
        printCellProcessorChain(cellProcessor, name.getMethodName());
