...
public class LocalDateCellProcessorBuilderTest {
    ...
    private static final LocalDate TEST_VALUE_1_OBJ = new LocalDate(2016, 2, 29);
    ...
    private static final LocalDate TEST_VALUE_2_OBJ = new LocalDate(2020, 1, 31);
    ...
    private static final LocalDate TEST_VALUE_INPUT_DEFAULT_OBJ = new LocalDate(2000, 1, 1);
    ...
    private static final LocalDate TEST_VALUE_OUTPUT_DEFAULT_OBJ = new LocalDate(2015, 12, 31);
    ...
    private static final LocalDate TEST_VALUE_MIN_OBJ = new LocalDate(2000, 1, 10);
    ...
    private static final LocalDate TEST_VALUE_MAX_OBJ = new LocalDate(2010, 12, 31);
