...
public class DurationCellProcessorBuilderTest {
    ...
    private static final Duration TEST_VALUE_1_OBJ = Duration.parse("PT0S");
    private static final String TEST_VALUE_1_STR_NORMAL = "PT0S";
    
    private static final Duration TEST_VALUE_2_OBJ = Duration.parse("PT-100S");
    private static final String TEST_VALUE_2_STR_NORMAL = "PT-100S";
    
    private static final Duration TEST_VALUE_INPUT_DEFAULT_OBJ = Duration.parse("PT123S");
    private static final String TEST_VALUE_INPUT_DEFAULT_STR_NORMAL = "PT123S";
    
    private static final Duration TEST_VALUE_OUTPUT_DEFAULT_OBJ = Duration.parse("PT-245S");
    private static final String TEST_VALUE_OUTPUT_DEFAULT_STR_NORMAL = "PT-245S";
