...
public class LongCellProcessorBuilderTest {
    ...
    public static class LongTest {
        ...
        private LongCellProcessorBuilder builder;
        ...
        @Before
        public void setUp() {
            builder = new LongCellProcessorBuilder();
        }
        
        /** for min/max diff value */
        private static final Long TEST_VALUE_DIFF = toLong("1");
        ...
        private static final Long TEST_VALUE_2_OBJ = toLong("-23456");
        private static final String TEST_VALUE_2_STR_NORMAL = "-23456";
        private static final String TEST_VALUE_2_STR_FORMATTED = "-23,456";
        
        private static final Long TEST_VALUE_INPUT_DEFAULT_OBJ = toLong("112233");
        ...
        private static final Long TEST_VALUE_OUTPUT_DEFAULT_OBJ = toLong("-223344");
        ...
        private static final Long TEST_VALUE_MIN_OBJ = toLong("-54321");
        ...
        private static final Long TEST_VALUE_MAX_OBJ = toLong("98765");
        ...
        public void testBuildInput_default() {
            ...
            Annotation[] annos = getAnnotations(TestCsv.class, "long_default");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
            
            assertThat(cellProcessor, hasCellProcessor(NotNull.class));
            assertThat(cellProcessor, hasCellProcessor(ParseLong.class));
            ...
            try {
                ...
                CellProcessor errorProcessor = e.getProcessor();
                assertThat(errorProcessor, is(instanceOf(ParseLong.class)));
            }
        ...
        public void testBuildOutput_default() {
            ...
            Annotation[] annos = getAnnotations(TestCsv.class, "long_default");
            CellProcessor cellProcessor = builder.buildOutputCellProcessor(Long.class, annos, false);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildOutput_default_ignoreValidation() {
            ...
            Annotation[] annos = getAnnotations(TestCsv.class, "long_default");
            CellProcessor cellProcessor = builder.buildOutputCellProcessor(Long.class, annos, true);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_optional() {
            ...
            Annotation[] annos = getAnnotations(TestCsv.class, "long_optional");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_trim() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_trim");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_defaultValue() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_defaultValue");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_defaultValue_format() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_defaultValue_format");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_default_format_invalidAnnotation() {
            ...
            Annotation[] annos = getAnnotations(TestCsv.class, "long_defaultValue_format_invalid");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
        ...
        public void testBuildInput_equalsValue() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_equalsValue");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_equalsValue_format() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_equalsValue_format");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_unique() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_unique");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_unique_format() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_unique_format");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_combine1() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_combine1");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_combine_format1() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_combine_format1");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_min() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_min");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
            ...
            {
                Long obj = TEST_VALUE_MIN_OBJ + TEST_VALUE_DIFF;
        ...
        public void testBuildInput_min_format() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_min_format");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_max() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_max");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
            ...
            // less than max value
            {
                Long obj = TEST_VALUE_MAX_OBJ - TEST_VALUE_DIFF;
                String str = obj.toString();
        ...
        public void testBuildInput_max_format() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_max_format");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_range() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_range");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_range_format() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_range_format");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildInput_format_lenient() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_format_lenient");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
            
            assertThat(cellProcessor, hasCellProcessor(ParseLocaleNumber.class));
            
            assertThat(cellProcessor.execute("12,345.567", ANONYMOUS_CSVCONTEXT), is(toLong("12345")));
            assertThat(cellProcessor.execute("12,345", ANONYMOUS_CSVCONTEXT), is(toLong("12345")));
        ...
        public void testBuildOutput_format_lenient() {
            ...
            assertThat(cellProcessor.execute(toLong("12345"), ANONYMOUS_CSVCONTEXT), is("12,345.0"));
            
        }
        
        @Test
        public void testBuildInput_format_currency() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_format_currency");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
            
            assertThat(cellProcessor, hasCellProcessor(ParseLocaleNumber.class));
            
            assertThat(cellProcessor.execute("USD 12,345.0000", ANONYMOUS_CSVCONTEXT), is(toLong("12345")));
        ...
        public void testBuildOutput_format_currency() {
            ...
            assertThat(cellProcessor.execute(toLong("12345"), ANONYMOUS_CSVCONTEXT), is("USD 12,345.0000"));
            
        }
        
        @Test
        public void testBuildInput_format_roundingMode() {
            Annotation[] annos = getAnnotations(TestCsv.class, "long_format_roundingMode");
            CellProcessor cellProcessor = builder.buildInputCellProcessor(Long.class, annos);
            printCellProcessorChain(cellProcessor, name.getMethodName());
        ...
        public void testBuildOutput_format_roundingMode() {
            ...
            assertThat(cellProcessor.execute(toLong("12345"), ANONYMOUS_CSVCONTEXT), is("12,345"));
    ...
    /**
     * Tests for primitive long.
     *
     */
    public static class PrivimiveLongTest {
        ...
        /** for min/max diff value */
        private static final long TEST_VALUE_DIFF = 1L;
        
        private static final String TEST_FORMATTED_PATTERN = "#,###";
        
        private static final long TEST_VALUE_PRIMITIVE_INIT_OBJ = 0;
        
        private static final long TEST_VALUE_1_OBJ = 12345;
        private static final String TEST_VALUE_1_STR_NORMAL = "12345";
        private static final String TEST_VALUE_1_STR_FORMATTED = "12,345";
        
        private static final long TEST_VALUE_2_OBJ = -23456;
        private static final String TEST_VALUE_2_STR_NORMAL = "-23456";
        private static final String TEST_VALUE_2_STR_FORMATTED = "-23,456";
        
        private static final long TEST_VALUE_INPUT_DEFAULT_OBJ = 112233;
        private static final String TEST_VALUE_INPUT_DEFAULT_STR_NORMAL = "112233";
        private static final String TEST_VALUE_INPUT_DEFAULT_STR_FORMATTED = "112,233";
        
        private static final long TEST_VALUE_OUTPUT_DEFAULT_OBJ = -223344;
        private static final String TEST_VALUE_OUTPUT_DEFAULT_STR_NORMAL = "-223344";
        private static final String TEST_VALUE_OUTPUT_DEFAULT_STR_FORMATTED = "-223.344";
        
        private static final long TEST_VALUE_MIN_OBJ = -54321;
        private static final String TEST_VALUE_MIN_STR_NORMAL = "-54321";
        private static final String TEST_VALUE_MIN_STR_FORMATTED = "-54,321";
        
        private static final long TEST_VALUE_MAX_OBJ = 98765;
        private static final String TEST_VALUE_MAX_STR_NORMAL = "98765";
        private static final String TEST_VALUE_MAX_STR_FORMATTED = "98,765";
        ...
        public void testBuildOutput_optional() {
            ...
            assertThat(cellProcessor.execute(0L, ANONYMOUS_CSVCONTEXT), is(TEST_VALUE_PRIMITIVE_INIT_OBJ));
        ...
        public void testBuildInput_format_lenient() {
            ...
            assertThat(cellProcessor.execute("12,345.567", ANONYMOUS_CSVCONTEXT), is(12345L));
            assertThat(cellProcessor.execute("12,345", ANONYMOUS_CSVCONTEXT), is(12345L));
        ...
        public void testBuildOutput_format_lenient() {
            ...
            assertThat(cellProcessor.execute(12345L, ANONYMOUS_CSVCONTEXT), is("12,345.0"));
        ...
        public void testBuildInput_format_currency() {
            ...
            assertThat(cellProcessor.execute("USD 12,345.0000", ANONYMOUS_CSVCONTEXT), is(12345L));
        ...
        public void testBuildOutput_format_currency() {
            ...
            assertThat(cellProcessor.execute(12345L, ANONYMOUS_CSVCONTEXT), is("USD 12,345.0000"));
        ...
        public void testBuildOutput_format_roundingMode() {
            ...
            assertThat(cellProcessor.execute(12345L, ANONYMOUS_CSVCONTEXT), is("12,345"));
