...
/**
 * Test the {@link LocalDateTimeCellProcessorBuilder} CellProcessor.
 * 
 * @since 1.2
 * @author T.TSUCHIE
 *
 */
public class LocalDateTimeCellProcessorBuilderTest {
    
    @Rule
    public TestName name = new TestName();
    
    private LocalDateTimeCellProcessorBuilder builder;
    ...
    @Before
    public void setUp() {
        builder = new LocalDateTimeCellProcessorBuilder();
    }
    
    private static final String TEST_NORMAL_PATTERN = "uuuu-MM-dd HH:mm:ss";
    private static final String TEST_FORMATTED_PATTERN = "uu/M/d H:m:s";
    
    private static final LocalDateTime TEST_VALUE_1_OBJ = LocalDateTime.of(2016, 2, 29, 7, 12, 1);
    ...
    private static final LocalDateTime TEST_VALUE_2_OBJ = LocalDateTime.of(2020, 1, 31, 10, 8, 35);
    ...
    private static final LocalDateTime TEST_VALUE_INPUT_DEFAULT_OBJ = LocalDateTime.of(2000, 1, 1, 8, 2, 3);
    ...
    private static final LocalDateTime TEST_VALUE_OUTPUT_DEFAULT_OBJ = LocalDateTime.of(2015, 12, 31, 12, 31, 1);
    ...
    private static final LocalDateTime TEST_VALUE_MIN_OBJ = LocalDateTime.of(2000, 1, 1, 1, 0, 0);
    ...
    private static final LocalDateTime TEST_VALUE_MAX_OBJ = LocalDateTime.of(2010, 12, 31, 4, 59, 59);
    ...
    private static class TestCsv {
        ...
        LocalDateTime localdatetime_default;
        
        @CsvColumn(position=1, optional=true)
        LocalDateTime localdatetime_optional;
        
        @CsvColumn(position=2, trim=true)
        LocalDateTime localdatetime_trim;
        ...
        LocalDateTime localdatetime_defaultValue;
        ...
        LocalDateTime localdatetime_defaultValue_format;
        
        @CsvColumn(position=5, inputDefaultValue="2000-01-01 08:02:03")
        @CsvDateConverter(pattern=TEST_FORMATTED_PATTERN)
        LocalDateTime localdatetime_defaultValue_format_invalid;
        
        @CsvColumn(position=6, equalsValue=TEST_VALUE_1_STR_NORMAL)
        LocalDateTime localdatetime_equalsValue;
        
        @CsvColumn(position=7, equalsValue=TEST_VALUE_1_STR_FORMATTED)
        @CsvDateConverter(pattern=TEST_FORMATTED_PATTERN)
        LocalDateTime localdatetime_equalsValue_format;
        
        @CsvColumn(position=8, unique=true)
        LocalDateTime localdatetime_unique;
        
        @CsvColumn(position=9, unique=true)
        @CsvDateConverter(pattern=TEST_FORMATTED_PATTERN)
        LocalDateTime localdatetime_unique_format;
        ...
        LocalDateTime localdatetime_combine1;
    ...
    public void testBuildInput_default() {
        ...
        CellProcessor cellProcessor = builder.buildInputCellProcessor(LocalDateTime.class, annos);
        printCellProcessorChain(cellProcessor, name.getMethodName());
        
        assertThat(cellProcessor, hasCellProcessor(NotNull.class));
        assertThat(cellProcessor, hasCellProcessor(ParseLocalDateTime.class));
        ...
        try {
            ...
            CellProcessor errorProcessor = e.getProcessor();
            assertThat(errorProcessor, is(instanceOf(ParseLocalDateTime.class)));
        }
    ...
    public void testBuildOutput_default() {
        ...
        Annotation[] annos = getAnnotations(TestCsv.class, "localdatetime_default");
        CellProcessor cellProcessor = builder.buildOutputCellProcessor(LocalDateTime.class, annos, false);
        printCellProcessorChain(cellProcessor, name.getMethodName());
    ...
    public void testBuildOutput_default_ignoreValidation() {
        ...
        Annotation[] annos = getAnnotations(TestCsv.class, "localdatetime_default");
        CellProcessor cellProcessor = builder.buildOutputCellProcessor(LocalDateTime.class, annos, true);
        printCellProcessorChain(cellProcessor, name.getMethodName());
    ...
    public void testBuildInput_min() {
        ...
        {
            LocalDateTime obj = TEST_VALUE_MIN_OBJ.plusSeconds(1);
        ...
        // less than min value
        try {
            LocalDateTime obj = TEST_VALUE_MIN_OBJ.minusSeconds(1);
            String str = format(obj, TEST_NORMAL_PATTERN);
    ...
    public void testBuildInput_max() {
        ...
        // less than max value
        {
            LocalDateTime obj = TEST_VALUE_MAX_OBJ.minusSeconds(1);
            String str = format(obj, TEST_NORMAL_PATTERN);
        ...
        try {
            LocalDateTime obj = TEST_VALUE_MAX_OBJ.plusSeconds(1);
            String str = format(obj, TEST_NORMAL_PATTERN);
    ...
    public void testBuildOutput_lenient() {
        ...
        assertThat(cellProcessor, hasCellProcessor(FmtLocalDateTime.class));
