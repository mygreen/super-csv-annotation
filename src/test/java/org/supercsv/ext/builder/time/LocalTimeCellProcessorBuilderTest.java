...
public class LocalTimeCellProcessorBuilderTest {
    ...
    private static final LocalTime TEST_VALUE_1_OBJ = LocalTime.of(7, 12, 1);
    ...
    private static final LocalTime TEST_VALUE_2_OBJ = LocalTime.of(10, 8, 35);
    ...
    private static final LocalTime TEST_VALUE_INPUT_DEFAULT_OBJ = LocalTime.of(8, 2, 3);
    ...
    private static final LocalTime TEST_VALUE_OUTPUT_DEFAULT_OBJ = LocalTime.of(12, 31, 1);
    ...
    private static final LocalTime TEST_VALUE_MIN_OBJ = LocalTime.of(1, 0, 0);
    ...
    private static final LocalTime TEST_VALUE_MAX_OBJ = LocalTime.of(4, 59, 59);
