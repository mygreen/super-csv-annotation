...
/**
 * Test the {@link LocalDateCellProcessorBuilder} CellProcessor.
 * 
 * @since 1.2
 * @author T.TSUCHIE
 *
 */
public class LocalDateCellProcessorBuilderTest {
    
    @Rule
    public TestName name = new TestName();
    
    private LocalDateCellProcessorBuilder builder;
    ...
    @Before
    public void setUp() {
        builder = new LocalDateCellProcessorBuilder();
    }
    
    private static final String TEST_NORMAL_PATTERN = "uuuu-MM-dd";
    private static final String TEST_FORMATTED_PATTERN = "uu/M/d";
    
    private static final LocalDate TEST_VALUE_1_OBJ = LocalDate.of(2016, 2, 29);
    ...
    private static final LocalDate TEST_VALUE_2_OBJ = LocalDate.of(2020, 1, 31);
    ...
    private static final LocalDate TEST_VALUE_INPUT_DEFAULT_OBJ = LocalDate.of(2000, 1, 1);
    ...
    private static final LocalDate TEST_VALUE_OUTPUT_DEFAULT_OBJ = LocalDate.of(2015, 12, 31);
    ...
    private static final LocalDate TEST_VALUE_MIN_OBJ = LocalDate.of(2000, 1, 10);
    private static final String TEST_VALUE_MIN_STR_NORMAL = "2000-01-10";
    private static final String TEST_VALUE_MIN_STR_FORMATTED = "00/1/10";
    
    private static final LocalDate TEST_VALUE_MAX_OBJ = LocalDate.of(2010, 12, 31);
    ...
    private static class TestCsv {
        ...
        LocalDate localdatetime_default;
        
        @CsvColumn(position=1, optional=true)
        LocalDate localdatetime_optional;
        
        @CsvColumn(position=2, trim=true)
        LocalDate localdatetime_trim;
        ...
        LocalDate localdatetime_defaultValue;
        ...
        LocalDate localdatetime_defaultValue_format;
        
        @CsvColumn(position=5, inputDefaultValue="2000-01-01")
        @CsvDateConverter(pattern=TEST_FORMATTED_PATTERN)
        LocalDate localdatetime_defaultValue_format_invalid;
        
        @CsvColumn(position=6, equalsValue=TEST_VALUE_1_STR_NORMAL)
        LocalDate localdatetime_equalsValue;
        
        @CsvColumn(position=7, equalsValue=TEST_VALUE_1_STR_FORMATTED)
        @CsvDateConverter(pattern=TEST_FORMATTED_PATTERN)
        LocalDate localdatetime_equalsValue_format;
        
        @CsvColumn(position=8, unique=true)
        LocalDate localdatetime_unique;
        
        @CsvColumn(position=9, unique=true)
        @CsvDateConverter(pattern=TEST_FORMATTED_PATTERN)
        LocalDate localdatetime_unique_format;
        ...
        LocalDate localdatetime_combine1;
    ...
    public void testBuildInput_default() {
        ...
        CellProcessor cellProcessor = builder.buildInputCellProcessor(LocalDate.class, annos);
        printCellProcessorChain(cellProcessor, name.getMethodName());
        
        assertThat(cellProcessor, hasCellProcessor(NotNull.class));
        assertThat(cellProcessor, hasCellProcessor(ParseLocalDate.class));
        ...
        try {
            ...
            CellProcessor errorProcessor = e.getProcessor();
            assertThat(errorProcessor, is(instanceOf(ParseLocalDate.class)));
        }
    ...
    public void testBuildOutput_default() {
        ...
        Annotation[] annos = getAnnotations(TestCsv.class, "localdatetime_default");
        CellProcessor cellProcessor = builder.buildOutputCellProcessor(LocalDate.class, annos, false);
        printCellProcessorChain(cellProcessor, name.getMethodName());
    ...
    public void testBuildOutput_default_ignoreValidation() {
        ...
        Annotation[] annos = getAnnotations(TestCsv.class, "localdatetime_default");
        CellProcessor cellProcessor = builder.buildOutputCellProcessor(LocalDate.class, annos, true);
        printCellProcessorChain(cellProcessor, name.getMethodName());
    ...
    public void testBuildInput_min() {
        ...
        {
            LocalDate obj = TEST_VALUE_MIN_OBJ.plusDays(1);
        ...
        // less than min value
        try {
            LocalDate obj = TEST_VALUE_MIN_OBJ.minusDays(1);
            String str = format(obj, TEST_NORMAL_PATTERN);
    ...
    public void testBuildInput_max() {
        ...
        // less than max value
        {
            LocalDate obj = TEST_VALUE_MAX_OBJ.minusDays(1);
            String str = format(obj, TEST_NORMAL_PATTERN);
        ...
        try {
            LocalDate obj = TEST_VALUE_MAX_OBJ.plusDays(1);
            String str = format(obj, TEST_NORMAL_PATTERN);
    ...
    public void testBuildOutput_lenient() {
        ...
        assertThat(cellProcessor, hasCellProcessor(FmtLocalDate.class));
