...
/**
 * {@link CalendarProcessorBuilder}のテスタ
 *
 * @since 2.0
 * @author T.TSUCHIE
 *
 */
public class CalendarProcessorBuilderTest {
    ...
    private static final Calendar TEST_VALUE_1_OBJ = toCalendar(toDate(2016, 2, 29, 7, 12, 1));
    ...
    private static final Calendar TEST_VALUE_1_OBJ_TIMEZONE = toCalendar(toDate(2016, 2, 29, 16, 12, 1), TimeZone.getTimeZone("GMT"));
    private static final String TEST_VALUE_1_STR_LOCALE = "平成28年2月29日 午前7時12分1秒";
    private static final Calendar TEST_VALUE_1_OBJ_LOCALE = toCalendar(toDate(2016, 2, 29, 7, 12, 1), Utils.getLocale("ja_JP_JP"));
    
    @CsvBean
    private static class TestCsv {
        
        @CsvColumn(number=1)
        Calendar col_default;
        ...
        Calendar col_lenient;
        
        @CsvColumn(number=4)
        @CsvDateTimeFormat(timezone="GMT")
        Calendar col_timezone;
        ...
        Calendar col_message;
        
        @CsvColumn(number=11)
        @CsvDateTimeFormat(message="")
        Calendar col_message_empty;
        ...
        Calendar col_message_variables;
    ...
    public void testBuildForReading_default() {
        ...
        
        {
            ...
            Calendar expected = TEST_VALUE_1_OBJ;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForWriging_default() {
        ...
        {
            // valid input
            Calendar input = TEST_VALUE_1_OBJ;
    ...
    public void testBuildForReading_timezone() {
        ...
        
        {
            ...
            String input = TEST_VALUE_1_STR_NORMAL;
            Calendar expected = TEST_VALUE_1_OBJ_TIMEZONE;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForWriting_timezone() {
        ...
        {
            // valid input
            Calendar input = TEST_VALUE_1_OBJ_TIMEZONE;
            String expected = TEST_VALUE_1_STR_NORMAL;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForReading_locale() {
        ...
        
        {
            ...
            Calendar expected = TEST_VALUE_1_OBJ_LOCALE;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
