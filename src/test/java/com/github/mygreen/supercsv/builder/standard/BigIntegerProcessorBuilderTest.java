...
/**
 * Test the {@link BigIntegerProcessorBuilder}
 *
 * @version 2.0
 * @since 1.2
 * @author T.TSUCHIE
 *
 */
public class BigIntegerProcessorBuilderTest {
    ...
    private static class TestCsv {
        ...
        BigInteger col_message_variables;
    ...
    public void testBuildForReading_default() {
        ...
        
        {
            ...
            BigInteger expected = TEST_VALUE_1_OBJ;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForWriging_default() {
        ...
        {
            // valid input
            BigInteger input = TEST_VALUE_1_OBJ;
