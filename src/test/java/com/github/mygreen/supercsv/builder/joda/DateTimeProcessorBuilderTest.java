...
/**
 * {@link DateTimeProcessorBuilder}のテスタ
 *
 * @since 2.0
 * @author T.TSUCHIE
 *
 */
public class DateTimeProcessorBuilderTest {
    ...
    private static final String TEST_FORMATTED_PATTERN = "yy/M/d H:m:sZZ";
    
    private static final DateTime TEST_VALUE_1_OBJ = new DateTime(2016, 2, 29, 7, 12, 1, DateTimeZone.forOffsetHours(+9));
    private static final String TEST_VALUE_1_STR_NORMAL = "2016-02-29 07:12:01+09:00";
    private static final String TEST_VALUE_1_STR_FORMATTED = "16/2/29 7:12:1+09:00";
    
    private static final String TEST_VALUE_1_STR_LENIENT = "2016-01-60 07:12:01+09:00";
    private static final DateTime TEST_VALUE_1_OBJ_TIMEZONE = new DateTime(2016, 2, 29, 7, 12, 1, DateTimeZone.forOffsetHours(+0));
    private static final String TEST_VALUE_1_STR_TIMEZONE = "2016-02-29 07:12:01+00:00";
    
    @CsvBean
    private static class TestCsv {
        
        @CsvColumn(number=1)
        DateTime col_default;
        ...
        DateTime col_message_variables;
    ...
    public void testBuildForReading_default() {
        ...
        
        {
            ...
            DateTime expected = TEST_VALUE_1_OBJ;
//            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
            assertThat(((DateTime)processor.execute(input, ANONYMOUS_CSVCONTEXT)).getMillis()).isEqualTo(expected.getMillis());
        }
    ...
    public void testBuildForWriging_default() {
        ...
        {
            // valid input
            DateTime input = TEST_VALUE_1_OBJ;
...
//            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
    ...
    public void testBuildForReading_timezone() {
        ...
        
        {
            ...
            String input = TEST_VALUE_1_STR_TIMEZONE;
            DateTime expected = TEST_VALUE_1_OBJ_TIMEZONE;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForWriting_timezone() {
        ...
        {
            // valid input
            DateTime input = TEST_VALUE_1_OBJ_TIMEZONE;
    ...
    public void testErrorMessage_format() {
        ...
        try {
            ...
            List<String> messages = exceptionConverter.convertAndFormat((SuperCsvValidationException)e, beanMapping);
            assertThat(messages).hasSize(1)
                    .contains("[2行, 2列] : 項目「col_format」の値（abc）は、日時の書式「yy/M/d H:m:sZZ」として不正です。");                
        }
    ...
    public void testErrorMessage_variables() {
        ...
        try {
            ...
            List<String> messages = exceptionConverter.convertAndFormat((SuperCsvValidationException)e, beanMapping);
            assertThat(messages).hasSize(1)
                    .contains("lineNumber=1, rowNumber=2, columnNumber=12, label=col_message_variables, validatedValue=abc, pattern=yy/M/d H:m:sZZ");                
        }
    ...
    public void testErrorMessage_typeMismatch() {
        ...
        try {
            ...
            List<String> messages = exceptionConverter.convertAndFormat((SuperCsvValidationException)e, beanMapping);
            assertThat(messages).hasSize(1)
                    .contains("[2行, 1列] : 項目「col_default」の値（abc）は、日時の書式「yyyy-MM-dd HH:mm:ssZZ」として不正です。");                
        }
