...
/**
 * Test the {@link SqlDateProcessorBuilder}
 *
 * @version 2.0
 * @since 1.2
 * @author T.TSUCHIE
 *
 */
public class SqlDateProcessorBuilderTest {
    ...
    private static final String TEST_LOCALE_PATTERN = "GGGGy年M月d日";
    ...
    private static final Date TEST_VALUE_1_OBJ_TIMEZONE = toSqlDate(2016, 2, 29);
    private static final String TEST_VALUE_1_STR_LOCALE = "平成28年2月29日";
