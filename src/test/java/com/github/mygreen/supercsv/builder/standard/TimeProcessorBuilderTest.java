...
/**
 * Test the {@link TimeProcessorBuilder}
 *
 * @version 2.0
 * @since 1.2
 * @author T.TSUCHIE
 *
 */
public class TimeProcessorBuilderTest {
    ...
    private static final String TEST_LOCALE_PATTERN = "aaaH時m分s秒";
    ...
    private static final Time TEST_VALUE_1_OBJ_TIMEZONE = toTime(16, 12, 1);
    private static final String TEST_VALUE_1_STR_LOCALE = "午前7時12分1秒";
    ...
    public void testBuildForReading_default() {
        ...
        
        {
            ...
            Time expected = TEST_VALUE_1_OBJ;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForReading_timezone() {
        ...
        
        {
            ...
            String input = TEST_VALUE_1_STR_NORMAL;
            Time expected = TEST_VALUE_1_OBJ_TIMEZONE;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
    ...
    public void testBuildForWriting_timezone() {
        ...
        {
            // valid input
            Time input = TEST_VALUE_1_OBJ_TIMEZONE;
            String expected = TEST_VALUE_1_STR_NORMAL;
            assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
        }
