...
/**
 * Test the {@link DoubleProcessorBuilder}
 *
 * @version 2.0
 * @since 1.2
 * @author T.TSUCHIE
...
public class DoubleProcessorBuilderTest {
    ...
    public static class WrappterTest {
        ...
        private static final Double TEST_VALUE_1_OBJ = toDouble("12345.67d");
        ...
        public void testBuildForReading_default() {
            ...
            
            {
                ...
                Double expected = TEST_VALUE_1_OBJ;
                assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
            }
    ...
    public static class PrimitiveTest {
        ...
        public void testBuildForReading_default() {
            ...
            
            {
                // null input
                String input = null;
                double expected = TEST_VALUE_PRIMITIVE_INIT_OBJ;
                assertThat((Object)processor.execute(input, ANONYMOUS_CSVCONTEXT)).isEqualTo(expected);
            }
