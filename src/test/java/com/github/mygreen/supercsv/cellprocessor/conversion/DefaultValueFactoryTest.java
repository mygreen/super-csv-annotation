...
public class DefaultValueFactoryTest {
    ...
    private DefaultValueFactory factory;
    ...
    public void setUp() throws Exception {
        this.factory = new DefaultValueFactory();
        
        this.config = new Configuration();
    }
    
    private static final String DEFAULT_VALUE = "blue";
    
    @CsvBean
    private static class TestCsv {
        
        @CsvColumn(number=1)
        @CsvDefaultValue(DEFAULT_VALUE)
    ...
    public void testCreate_default() {
        ...
        CsvDefaultValue anno = field.getAnnotationsByGroup(CsvDefaultValue.class, groupEmpty).get(0);
        
        {
            ...
            assertThat(processor.get()).isInstanceOf(DefaultValue.class);
            
            DefaultValue actual = (DefaultValue)processor.get();
