...
/**
 * {@link LeftPadFactory}のテスタ
 *
 * @since 2.0
 * @author T.TSUCHIE
 *
 */
public class LeftPadFactoryTest {
    
    @Rule
    public TestName name = new TestName();
    
    private LeftPadFactory factory;
    ...
    public void setUp() throws Exception {
        this.factory = new LeftPadFactory();
    ...
    public void testCreate_default() {
        ...
        CsvLeftPad anno = field.getAnnotationsByGroup(CsvLeftPad.class, groupEmpty).get(0);
        
        {
            ...
            assertThat(processor.get()).isInstanceOf(LeftPad.class);
            
            LeftPad actual = (LeftPad)processor.get();
    ...
    public void testCreate_wornd_size() {
        ...
        try {
            ...
            assertThat(e).isInstanceOf(SuperCsvInvalidAnnotationException.class)
                .hasMessage("'%s' において、アノテーション @CsvLeftPad の属性 'size' の値（0）は、1以上の値を設定してください。",
