...
/**
 * {@link LowerFactory}のテスタ
 *
 * @since 2.0
 * @author T.TSUCHIE
 *
 */
public class LowerFactoryTest {
    
    @Rule
    public TestName name = new TestName();
    
    private LowerFactory factory;
    ...
    public void testCreate_default() {
        ...
        CsvLower anno = field.getAnnotationsByGroup(CsvLower.class, groupEmpty).get(0);
        
        {
            ...
            assertThat(processor.get()).isInstanceOf(Lower.class);
            
            Lower actual = (Lower)processor.get();
