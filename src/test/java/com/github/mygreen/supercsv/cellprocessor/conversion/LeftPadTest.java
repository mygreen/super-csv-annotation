...
public class LeftPadTest {
    ...
    public void setUp() throws Exception {
        this.processor = new LeftPad(5, ' ');
        this.processorChain = new LeftPad(5, ' ', new NextCellProcessor());
    ...
    public void testConstuctor_nextNull() {
        ...
        assertThatThrownBy(() -> new LeftPad(-1, '_', null)).isInstanceOf(NullPointerException.class);
    ...
    public void testConstuctor_padSizeLessThanZero() {
        ...
        assertThatThrownBy(() -> new LeftPad(0, '_')).isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new LeftPad(-1, '_')).isInstanceOf(IllegalArgumentException.class);
